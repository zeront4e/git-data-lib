...
/**
 * Configuration class for SSH connections that use GitHub token-based authentication.
 * This class extends the password-based SSH configuration but uses a token instead of a username/password pair.
 */
public class GdlGitHubTokenBasedSshConfiguration extends GdlPasswordBasedSshConfiguration {
    /**
     ...
     */
    public GdlGitHubTokenBasedSshConfiguration(String token, File knownHostsFile) {
